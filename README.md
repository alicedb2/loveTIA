...
This is a stripped down version of the [MIDIbox TIA](http://www.midibox.org/dokuwiki/doku.php?id=midibox_tia). It uses a Raspberry Pi Pico and MicroPython to control the Atari 2600 TIA chip for some old-school sound goodness.
